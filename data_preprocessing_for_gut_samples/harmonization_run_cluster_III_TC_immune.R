...
seurat_objects <- readRDS("seurat_part_TC_immune_1.RDS")
seurat_objects <- c(seurat_objects,readRDS("seurat_part_TC_immune_2.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_TC_immune_3.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_TC_immune_4.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_TC_immune_5.RDS"))
...
saveRDS(seurat_aggregated, "seurat_aggregated_TC_immune.RDS")
...
pdf("tSNE_filtered_TC_immune.pdf",
    height = 5, width = 16)
...
pdf("UMAP_filtered_TC_immune.pdf",
    height = 5, width = 16)
