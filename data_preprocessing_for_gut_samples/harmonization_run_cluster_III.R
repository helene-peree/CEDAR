...
seurat_objects <- readRDS("seurat_part_1.RDS")
seurat_objects <- c(seurat_objects,readRDS("seurat_part_2.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_3.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_4.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_5.RDS"))
...
seurat_aggregated <- FindClusters(object = seurat_aggregated, resolution = 0.5)

saveRDS(seurat_aggregated, "seurat_aggregated_filtered.RDS")
