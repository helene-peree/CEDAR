...
seurat_objects <- readRDS("seurat_part_TC_epithelium_1.RDS")
seurat_objects <- c(seurat_objects,readRDS("seurat_part_TC_epithelium_2.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_TC_epithelium_3.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_TC_epithelium_4.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_TC_epithelium_5.RDS"))
...
saveRDS(seurat_aggregated, "seurat_aggregated_TC_epithelium.RDS")
...
pdf("tSNE_filtered_TC_epithelium.pdf",
    height = 5, width = 16)
...
pdf("UMAP_filtered_TC_epithelium.pdf",
    height = 5, width = 16)
