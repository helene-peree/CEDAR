...
seurat_objects <- readRDS("seurat_part_IL_1.RDS")
seurat_objects <- c(seurat_objects,readRDS("seurat_part_IL_2.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_IL_3.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_IL_4.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_IL_5.RDS"))
...
saveRDS(seurat_aggregated, "seurat_aggregated_IL_filtered.RDS")
