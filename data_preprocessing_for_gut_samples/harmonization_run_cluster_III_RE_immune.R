...
seurat_objects <- readRDS("seurat_part_RE_immune_1.RDS")
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_immune_2.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_immune_3.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_immune_4.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_immune_5.RDS"))
...
saveRDS(seurat_aggregated, "seurat_aggregated_RE_immune.RDS")
...
pdf("tSNE_filtered_RE_immune.pdf",
    height = 5, width = 16)
...
pdf("UMAP_filtered_RE_immune.pdf",
    height = 5, width = 16)
