...
seurat_objects <- readRDS("seurat_part_RE_1.RDS")
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_2.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_3.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_4.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_5.RDS"))
...
saveRDS(seurat_aggregated, "seurat_aggregated_RE_filtered.RDS")
