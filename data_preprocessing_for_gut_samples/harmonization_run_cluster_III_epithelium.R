...
seurat_objects <- readRDS("seurat_part_epithelium_1.RDS")
seurat_objects <- c(seurat_objects,readRDS("seurat_part_epithelium_2.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_epithelium_3.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_epithelium_4.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_epithelium_5.RDS"))

more_49_cells <- unlist(lapply(seurat_objects, function(x){length(x$orig.ident)>=50}))
...
saveRDS(seurat_aggregated, "seurat_aggregated_epithelium.RDS")
