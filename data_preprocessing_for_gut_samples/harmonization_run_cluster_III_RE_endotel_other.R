...
seurat_objects <- readRDS("seurat_part_RE_endotel_other_1.RDS")
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_endotel_other_2.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_endotel_other_3.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_endotel_other_4.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_RE_endotel_other_5.RDS"))
...
saveRDS(seurat_aggregated, "seurat_aggregated_RE_endotel_other.RDS")
...
pdf("tSNE_filtered_RE_endotel_other.pdf",
    height = 5, width = 16)
...
pdf("UMAP_filtered_RE_endotel_other.pdf",
    height = 5, width = 16)
