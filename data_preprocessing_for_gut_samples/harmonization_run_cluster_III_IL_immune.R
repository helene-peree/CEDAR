...
seurat_objects <- readRDS("seurat_part_IL_immune_1.RDS")
seurat_objects <- c(seurat_objects,readRDS("seurat_part_IL_immune_2.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_IL_immune_3.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_IL_immune_4.RDS"))
seurat_objects <- c(seurat_objects,readRDS("seurat_part_IL_immune_5.RDS"))
...
saveRDS(seurat_aggregated, "seurat_aggregated_IL_immune.RDS")
...
pdf("tSNE_filtered_IL_immune.pdf",
    height = 5, width = 16)
...
pdf("UMAP_filtered_IL_immune.pdf",
    height = 5, width = 16)
