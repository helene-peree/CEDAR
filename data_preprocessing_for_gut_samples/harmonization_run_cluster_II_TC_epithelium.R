...
cell_names_ileum <- readRDS("../../identification/cell_names_transversum.RDS")
...
saveRDS(seurat_objects, paste0("seurat_part_TC_epithelium_",arguments,".RDS"))
